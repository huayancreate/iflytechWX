...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.contentLabel.font=[UIFont fontWithName:FONT size:13];
...
-(void)setFrame:(CGRect)frame
{
    ...
    if(self.chartMessage.messageType == messageSys)
    {
        contentLabelX=kContentStartMargin*0.8;
    }else if(self.chartMessage.messageType == messageFrom){
        contentLabelX=kContentStartMargin*0.8;
    }else if(self.chartMessage.messageType == messageTo){
