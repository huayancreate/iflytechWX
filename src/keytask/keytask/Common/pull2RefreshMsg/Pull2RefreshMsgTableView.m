...
@implementation Pull2RefreshMsgTableView
{
    Pull2RefreshMsgView *dragHeaderView;
    Pull2RefreshMsgView *dragFooterView;
...
- (void)addDragHeaderView
{
    if (self.shouldShowDragHeader && !dragHeaderView)
    {
        ...
        dragHeaderView = [[Pull2RefreshMsgView alloc]
...
- (void)addDragFooterView
{
    if (self.shouldShowDragFooter && !dragFooterView)
    {
        ...
        dragFooterView = [[Pull2RefreshMsgView alloc]
...
{
    Pull2RefreshMsgView *dragView = nil;
    if (headerRefreshing)
    {
