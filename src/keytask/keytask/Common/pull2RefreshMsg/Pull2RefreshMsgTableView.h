...
#import "Pull2RefreshMsgView.h"
#import "HYUserLoginModel.h"


typedef void(^DragEndBlock)(Pull2RefreshViewType);

@interface Pull2RefreshMsgTableView : UITableView<UIScrollViewDelegate, UITableViewDelegate>
...
@property (nonatomic, strong) HYUserLoginModel *user;
